...
<div class="social-icons">
  ...
  $social_media_websites = get_social_media_array();
    ...
    $key = $value['key'];
    $show_icon = $data[$key."_show"]; //$khafagy_icons_position."_".
    ...
    ?>
    <a class="<?php echo $key; ?>" href="<?php echo $link; ?>"><img src="<?php echo get_template_directory_uri().'/images/socials1/'.$key.'.png'; ?>"></a>
  <?php } ?>
</div>
<?php } ?>
