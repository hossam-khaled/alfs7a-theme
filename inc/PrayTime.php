...
class PrayTime
{
    ...
    var $Makkah_Ramadan = 8;    // Umm al-Qura, Makkah in Ramadan
    ...
    */
    ...
    function ThePrayTime($methodID = 0)
    {
        ...
        $this->methodParams[$this->Makkah_Ramadan]    = array(18.5, 1, 0, 1, 120);
